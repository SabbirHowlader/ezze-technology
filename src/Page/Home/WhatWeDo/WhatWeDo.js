    ...
    return (
        <div className='bg-blue-400'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 mx-5 lg:mx-16 pb-10'>
                ...
                <div>
                    <div>
                        <span className='text-5xl flex justify-center p-6 bg-rose-300 hover:text-orange-500 w-24  mx-auto rounded-full '><FaRocket></FaRocket></span>
                    </div>
                    <div className='mt-3'>
                        <h5 className='text-2xl font-bold mb-3 text-green-700'>Web Development</h5>
                        <p>
                            Web Development
                ...
                <div>
                    ...
                    <div className='mt-3'>
                        <h5 className='text-2xl font-bold mb-3 text-green-700'>Apps Development</h5>
                        <p>
                ...
                <div>
                    <div>
                        <span className='text-5xl flex justify-center p-6 bg-orange-300 hover:text-orange-500 w-24  mx-auto rounded-full'><FaGlobeAfrica></FaGlobeAfrica></span>
                    </div>
                    <div className='mt-3'>
                        <h5 className='text-2xl font-bold mb-3 text-green-700'>Digital Marketing</h5>
                        <p>
                            Digital Marketing
                ...
                <div>
                    <div>
                        <span className='text-5xl flex justify-center p-6 bg-lime-300 hover:text-orange-500 w-24  mx-auto rounded-full'><FaStore></FaStore></span>
                    </div>
                    <div className='mt-3'>
                        <h5 className='text-2xl font-bold mb-3 text-green-700'>Domain & Hosting</h5>
                        <p>
                ...
                <div>
                    <div>
                        <span className='text-5xl flex justify-center p-6 bg-green-300 hover:text-orange-500 w-24  mx-auto rounded-full'><FaVideo></FaVideo></span>
                    </div>
                    <div className='mt-3'>
                        <h5 className='text-2xl font-bold mb-3 text-green-700'>Live Streming</h5>
                        <p>
                ...
                <div>
                    <div>
                        <span className='text-5xl flex justify-center p-6 bg-fuchsia-300  w-24 hover:text-orange-500  mx-auto rounded-full'><FaWeightHanging></FaWeightHanging></span>
                    </div>
                    <div className='mt-3'>
                        <h5 className='text-2xl font-bold mb-3 text-green-700'>E-Business Solution</h5>
                        <p>
